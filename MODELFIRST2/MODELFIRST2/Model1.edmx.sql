...
-- --------------------------------------------------
-- Date Created: 08/20/2021 17:42:29
-- Generated from EDMX file: C:\Users\Tarde\Desktop\CURSO_NET\MODELFIRST2\MODELFIRST2\Model1.edmx
-- --------------------------------------------------
...
CREATE TABLE [dbo].[DEPARTAMENTOSet] (
    ...
    [UBICACION_FISCA_DEPARTA] nvarchar(max)  NOT NULL
);
GO
...
-- Creating foreign key on [ID_DEPATAMENTO] in table 'EMPLEADOSet'
ALTER TABLE [dbo].[EMPLEADOSet]
ADD CONSTRAINT [FK_DEPARTAMENTOEMPLEADO]
    FOREIGN KEY ([ID_DEPATAMENTO])
